...
def CountWordMode(threshold):   
    ...
    for i in range(threshold): # Defines a range
        ...
        if readchar == chr(27):     # Clicking the ESC button
        ...
        if right_letters == len(right_word):
            print (Back.GREEN + '\nCorrect! You typed '+ typed_word +  Style.RESET_ALL + '\n')
        else:
            print(Back.RED + '\nIncorrect! It was '+ right_word + ' but you typed ' + typed_word + Style.RESET_ALL + '\n')
